...
function ListingPage1() {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-gradient-to-br from-[#fff5f5] via-[#ffe9e9] to-[#ffd6d6] flex items-center justify-center relative overflow-auto mt-[50px]">
      <form
        action=""
        className="max-w-[900px] w-[90%] h-[550px] bg-white shadow-2xl rounded-[20px] px-[30px] py-[25px] flex items-center justify-start flex-col md:items-start gap-[15px] overflow-auto border border-pink-200"
      >
        {/* Back button */}
        <div
        ...
        <div className="w-full flex flex-col gap-2 mt-[60px]">
          ...
          <input
            ...
            id="title"
            placeholder="Enter the title"
            className="w-full h-[45px] border border-pink-300 rounded-lg px-4 focus:outline-none focus:ring-2 focus:ring-pink-400 transition duration-300 placeholder:text-gray-400"
          />
        </div>
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <textarea
            id="description"
            placeholder="Enter the description"
            className="w-full h-[100px] border border-pink-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400 transition duration-300 placeholder:text-gray-400 resize-none"
          />
        </div>
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="flex items-center justify-start w-[90%] h-[45px] border-[#ff8fa3] border-2 rounded-[10px] hover:border-[#ff5c8a] transition-all duration-300 bg-[#fff0f3]">
            <input
              type="file"
              id="img1"
